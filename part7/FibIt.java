...
public class FibIt implements  SeqIt {
    ...
    public int next() throws UsingIteratorPastEndException{
        // Check if fib will go past the end number; if so, throw the exception
        if (!(hasNext())) {
            throw new UsingIteratorPastEndException("= caught UsingIteratorPastEndException from FibIt");
        }
