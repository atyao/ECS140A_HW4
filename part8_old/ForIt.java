...
public class ForIt implements SeqIt {
    ...
    public int next() throws UsingIteratorPastEndException{
        // Check if for loop will go past the end number; if so, throw the exception
        if (!(hasNext()))
            throw new UsingIteratorPastEndException("= caught UsingIteratorPastEndException from ForIt");
